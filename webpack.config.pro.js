...
const MiniCssExtractPlugin = require('mini-css-extract-plugin') // 引入mini-css-extract-plugin插件，生成一个MiniCssExtractPlugin类  (默认打包时会将css文件打包到js文件内，使用mini-css-extract-plugin可以单独提取css文件)
        ...
        rules: [  // 转换的规则
            {
                ...
                use: [MiniCssExtractPlugin.loader, 'css-loader'], // 这里是使用顺序，从后往前，即先执行css-loader，在执行style-loader
                exclude: [
